...
const StudentAttendance = () => {
    ...
    const columns = [
        ...
        { field: "totalLectures", headerName: "Total Lectures", flex: 0.3 },
        // { field: "absent", headerName: "Absent Lectures", flex: 0.3 },
        {
            field: "attendedLectures",
            headerName: "Attended Lectures",
            flex: 0.4,
        },
    ...
    */
    ...
    student?.attendence?.forEach((item, index) => {
        rows.push({
            ...
            attendedLectures: item.attendedLectures,
