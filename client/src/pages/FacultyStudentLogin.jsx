...
const AnimatedWrapper = styled(animated.div)`
    ...
    overflow: hidden;
`;
const AnimatedLeft = styled(animated.div)`
    flex: 0.6;
    display: flex;
...
const AnimatedRight = styled(animated.div)`
    flex: 0.4;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
const LoginBox = styled(animated.form)`
    height: 300px;
    padding: 20px;
    border-radius: 10px;
    display: flex;
...
const FacultyStudentLogin = () => {
    ...
    // const slideLeftAnimation = useSpring({
    //     opacity: 1,
    ...
    //     opacity: 1,
    //     transform: isStudentLogin ? "translateX(0%)" : "translateX(100%)",
    //     from: { opacity: 0, transform: "translateX(30%)" },
    //     config: { tension: 120, friction: 14 },
    // });
        ...
        <Container>
            <AnimatedWrapper>
                <AnimatedLeft>
                    <Logo>UNI-VERSE</Logo>
                    <Desc>
                        Track your academics and stay connected with your peers
                    </Desc>
                </AnimatedLeft>
                <AnimatedRight>
                    <LoginBox>
