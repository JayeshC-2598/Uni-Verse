...
const AdminLogin = () => {
    ...
    // Animation for the left section (slide in from the left)
    ...
    // Animation for the right section (slide in from the right)
    const slideRightAnimation = useSpring({
        opacity: 1,
        transform: "translateX(0%)",
        from: { opacity: 0, transform: "translateX(30%)" },
        config: config.wobbly,
    ...
    return (
        <Container>
            <AnimatedWrapper style={fadeInAnimation}>
                <AnimatedLeft>
                    <Logo>UNI-VERSE</Logo>
                    <Desc>Admin Login</Desc>
                </AnimatedLeft>
                <AnimatedRight style={slideRightAnimation}>
                    <LoginBox>
                        <LoginInput
